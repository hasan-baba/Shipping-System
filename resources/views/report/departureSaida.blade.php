    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <p>تحية و بعد..</p>
                <p>الموضوع: طلب دخول بحارة للمغادرة</p>
                <p>نرجو الموافقة على الدخول الى الأراضي اللبنانية، للبحارة الأتية أسمائهم أدناه و الموجودين على متن</p>
                <p>الباخرة {{$trip->ship->ship_name}}</span> رافعة العلم <span>{{$trip->ship->flag}}</span>  و {{$status}} مرفأ <span>{{$trip->port->port_arabic_name}}  بتاريخ <span>{{$trip->expected_arrival_date}}</p>
            </div>
        </div>
        <div class="row">
            <p>للمغادرة عن طريق
        ...
        <div class="row mt-2">
            <div class="col-12">
                ...
                <p>على إنزال البحارة المذكورين أعلاه عن متن الباخرة {{$trip->ship->ship_name}} و {{$status}} مرفأ <span>{{$trip->port->port_arabic_name}}</span></p>
