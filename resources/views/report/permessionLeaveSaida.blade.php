...
<div class="container-fluid">
    <div class="row" dir="ltr">
        ...
        <h3 class="text-center" style="text-decoration: underline">The Chief Of  Saida Port Immigration</h3>
        <p>Dear Sirs,</p>
    ...
    <div class="row" dir="rtl" style="font-size: 17px">
        @php $year = date('Y') @endphp
        <p>مرفأ  صيدا  في<span class="px-3"></span> / <span class="px-3"></span> / <span>{{$year}}</span> </p>
        <h3 class="px-4">حضرة رئيس مركز أمن عام مرفأ صيدا المحترم</h3>
