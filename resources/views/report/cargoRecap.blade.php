    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="row">
                ...
                <div class="col-9">
                    <p style="font-weight: bold;">{{$trip->ship->shiptype->ship_type_ab}} {{$trip->ship->ship_name}}</p>
                </div>
            </div>
        </div>
        <div class="col-12">
        ...
        <div class="col-12">
            <div class="row">
                ...
                <div class="col-9">
                    <p style="float: left"><span style="font-weight: bold;">{{$total}}</span> <span>METRIC TONS IN BULK</span></p>
                </div>
            </div>
        </div>
        <div class="col-12">
