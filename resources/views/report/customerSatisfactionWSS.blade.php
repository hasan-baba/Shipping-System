...
<body>
    ...
    <div class="container-fluid" style="font-size: 13px" dir="ltr">
        <div class="row">
            <div class="col-12">
                <img src="/assets/img/wilhelmsen.jpg" width="30%" style="float: right;" class="rounded" alt="..."/>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <p class="m-0">
                    Wilhelmsen Ships Service is committed to improve its service performance on a continuous basis to ensure customer satisfaction. Feedback is important to help the Wilhelmsen Ships Service organization fulfill customer's expectations and it would be greatly appreciated if you would complete this survery and return to your agent during this visit. Thank you.
                </p>
                <div class="row">
                    <div class="col-12">
        ...
        <div class="row">
            <div class="col-12">
                <p>
                    5. How would you rate the availability of WSS staff ?
                </p>
            </div>
            <div class="col-12" style="padding-left: 2rem; margin-bottom: 12px;">
                {{numbers()}}
        ...
        <div class="row mt-2">
            <div class="col-12">
                <span style="margin-right: 0.5rem">10. Would you recommend Wilhelmsen Ships Service to others?</span>
